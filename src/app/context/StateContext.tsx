...
export const StateContext = ({ children }: any) => {
  ...
  const onAdd = (
    product: { _id: any; price: number; quantity: any; name: any },
    quantity: number
  ) => {
  ...
  const toggleCartItemQuanitity = (id: any, value: string) => {
    foundProduct = cartItems.find((item: { _id: any }) => item._id === id);
    index = cartItems.findIndex((product: { _id: any }) => product._id === id);
    const newCartItems = cartItems.filter(
